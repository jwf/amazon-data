...
const RetailBreakdownComponent: React.FC = () => {
  const { data, loading, error } = useApiData<RetailBreakdown>(getRetailBreakdown);
  ...
  if (error) {
    return <div className="text-center py-8 text-red-500">Failed to load retail breakdown</div>;
  }
